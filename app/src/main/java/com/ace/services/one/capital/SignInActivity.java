...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get_otp.setOnClickListener(view -> {
            ...
            if (isPhoneValid(txtPhone) && !txtPhone.isEmpty()){
                ...
                get_otp.setCardBackgroundColor(getResources().getColor(R.color.light_button));
                ...
                PhoneAuthOptions phoneAuthOptions = PhoneAuthOptions.newBuilder(auth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                get_otp.setCardBackgroundColor(getResources().getColor(R.color.button));
        ...
        verify_otp.setOnClickListener(view -> {
            ...
            if (txtOtp.isEmpty())
                ...
                verify_otp.setCardBackgroundColor(getResources().getColor(R.color.light_button));
                ...
                auth.signInWithCredential(credential)
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()){
                                ...
                                databaseReference.child("users").orderByChild("userId").equalTo(userId).addValueEventListener(isUserExistsListener);
    ...
    private final ValueEventListener isUserExistsListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if (!snapshot.exists()){
                UserModel userModel = new UserModel(userId, Objects.requireNonNull(auth.getCurrentUser()).getPhoneNumber(), "NA", "NA", "NA");
                Map<String, UserModel> userModelMap = new HashMap<>();
                userModelMap.put(userId, userModel);
                databaseReference.child("users").setValue(userModelMap);
            }
        }
